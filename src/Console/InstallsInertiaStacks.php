...
trait InstallsInertiaStacks
{
    ...
    protected function installInertiaReactStack()
    {
        ...
        if (!$this->requireComposerPackages(
            ['inertiajs/inertia-laravel:^0.6.3', 'laravel/sanctum:^3.2', 'tightenco/ziggy:^1.0']
        )) {
            return 1;
        }
        ...
        copy(
            __DIR__ . '/../../stubs/inertia-common/app/Http/Middleware/HandleInertiaRequests.php',
            app_path('Http/Middleware/HandleInertiaRequests.php')
        );

        // Views...
        copy(
            __DIR__ . '/../../stubs/inertia-react/resources/views/app.blade.php',
        ...
        if ($this->option('typescript')) {
            (new Filesystem)->copyDirectory(
                __DIR__ . '/../../stubs/inertia-react-ts/resources/js/Components',
    ...
    protected function installInertiaReactSsrStack()
    {
        if ($this->option('typescript')) {
            ...
            $this->replaceInFile(
                ...
                "input: 'resources/js/app.tsx'," . PHP_EOL . "            ssr: 'resources/js/ssr.tsx',",
            ...
            $this->replaceInFile(
                ...
                "input: 'resources/js/app.jsx'," . PHP_EOL . "            ssr: 'resources/js/ssr.jsx',",
                base_path('vite.config.js')
            );
        }
