...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Install the basic site components and resources for necessary stack';
    ...
    public function handle()
    {
        ...
        $this->components->error('Invalid stack. Supported stacks are [blade] or [vue].');
...
//        });
    ...
    /**
     * Add a given string into a given file.
     *
     * @param string $string
     * @param string $path
     * @return void
    ...
    {
        file_put_contents($path, file_get_contents($path) . PHP_EOL . $string . PHP_EOL);
    }
